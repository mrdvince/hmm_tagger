...
## Getting Started
Download a copy of the project from GitHub [here](https://github.com/droid021/hmm-tagger) and then run a Jupyter server locally with [Anaconda](https://www.anaconda.com/download/).
...
```
$ git clone https://github.com/droid021/hmm-tagger
```
